...
(function($){
	$.fn.vslide = function(options){
		...
		this.each(function(){
			...
			if(options.left_bt){
				$(options.box).find("#"+options.left_bt).click(function(){doAni('left',$(this).parent(".outer").find("ul"));});
			}
			if(options.right_bt){
				$(options.box).find("#"+options.right_bt).click(function(){doAni('right',$(this).parent(".outer").find("ul"));});
			}
